// Slick Updater
//
// Ported from scripts/byoe/updater.js with its logic intact. The security
// property is the reason this file is long: an update is only installed if
// GitHub holds a SLSA build-provenance attestation whose subject digest
// matches the bytes we downloaded, signed by a Fulcio certificate chaining to
// the sigstore public-good root, whose SAN names Slick's own release workflow.
// A download that fails any of those checks is refused rather than installed.
//
